...
class Ad(models.Model):
    ...
    title = models.CharField(
        max_length=20, verbose_name="Название товара", help_text="Название товара"
    )
    price = models.PositiveIntegerField(
        verbose_name="Цена товара", help_text="Цена товара"
    )
    description = models.TextField(
        max_length=200, verbose_name="Описание товара", help_text="Описание товара"
    )
...
class Feedback(models.Model):
    ...
    text = models.TextField(
        max_length=150, verbose_name="Текст отзыва", help_text="Текст отзыва"
    )
    author = models.ForeignKey(
        User,
        on_delete=models.SET_NULL,
